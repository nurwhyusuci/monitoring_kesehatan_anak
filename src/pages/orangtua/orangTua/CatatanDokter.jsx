...
import {
  FaUserMd, FaCalendarAlt, FaMapMarkerAlt, FaWeight,
  FaRulerVertical, FaThermometerHalf, FaNotesMedical,
  FaPrescriptionBottleAlt, FaClipboardList
} from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-blue-300 to-blue-100 p-4 sm:p-6 md:p-8 lg:p-12">
      <div className="max-w-screen-xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-6">Catatan Dokter</h2>
                  ...
                  <div className="bg-white p-5 rounded-lg border border-blue-200/50 shadow-sm">
                    ...
                    <div className="space-y-3 text-gray-700">
                      <div className="flex items-center gap-3">
                        ...
                        <span>Berat: <span className="font-medium">{item.berat}</span></span>
                      </div>
                      <div className="flex items-center gap-3">
                        <FaRulerVertical className="text-blue-500/70" />
                        <span>Tinggi: <span className="font-medium">{item.tinggi}</span></span>
                      </div>
                      <div className="flex items-center gap-3">
                        <FaThermometerHalf className="text-blue-500/70" />
                        <span>Suhu: <span className="font-medium">{item.suhu}</span></span>
                      </div>
                    </div>
                  </div>
