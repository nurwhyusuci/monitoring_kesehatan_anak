        ...
        <div className="absolute top-0 right-0 h-full w-72 bg-gradient-to-b from-blue-200 to-blue-100 shadow-xl z-50 p-4 border-l border-blue-300 rounded-l-xl animate-slide-in">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="text-left text-sm space-y-3 w-full px-4">
              <p className="flex items-start"><span className="mr-2">⚫</span><span><b>Anak</b>: Aisyah</span></p>
              <p className="flex items-center"><span className="mr-2">⚫</span><span><b>Kontak</b>: 0812-1234-5678</span></p>
              <p className="flex items-start"><span className="mr-2">⚫</span><span><b>Alamat</b>: <br className="md:hidden" />Jl. Merpati No. 7, Sleman</span></p>
            </div>
          </div>
        ...
        <section className="bg-white rounded-xl shadow overflow-hidden">
          ...
          <div className="p-4 flex justify-end border-t border-gray-200">
            <button 
              ...
              onClick={() => navigate('/dashboard/orangtua/riwayat-lengkap')}
            >
              Lihat Semua Riwayat
            </button>
          </div>
